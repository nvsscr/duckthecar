...
- A car can bonk a duckling without ending your run â€” the mother is the one who
  must survive
...
| file | what it is |
|---|---|
| `index.html` | the entire game â€” open it in a browser and it runs |
...
Off by default â€” the game keeps your best score locally and never touches the
